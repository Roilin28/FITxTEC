...
import { getRutinaDeep, RutinaCompleta, DiaRutina } from "../services/Routines";
...
type RootStackParamList = {
  ...
  Workout: undefined; // Para compatibilidad con Tabs
  Routines: undefined;
};
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const data = await getRutinaDeep(rutinaProg.rutinaId);
        if (!data) {
          setError("NOT_FOUND");
          setLoading(false);
          return;
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.emptyContainer}>
          ...
          >
            ...
            />
            <Text style={styles.goToRoutinesText}>Ver Rutinas</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    );
